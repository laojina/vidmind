package com.vidmind.server.utils;

import com.vidmind.server.dto.AgentState;
import com.vidmind.server.dto.AnalysisResult;
import com.vidmind.server.dto.ModeClassification;
import com.vidmind.server.dto.VideoChunk;
import com.vidmind.server.dto.VideoContext;
import com.vidmind.server.dto.VideoRetrievalIntent;
import com.vidmind.server.service.AgentExecutionBudget;
...
public class DeepSeekUtils {
    ...
    private static final String SYSTEM_POLICY = """
            你是 VidMind 的受控 Video Agent 模型组件，只执行当前请求开头明确指定的
